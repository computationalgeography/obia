...
# Creating tiles from fotogrammetry height data
fotogram_height_path = r"G:\08_FrieseZeegat_Fotogrammetrie\6_Vergelijking_met_Lidar\Data\Photogrammetry\FrieseZeegat_2018.tif"
mosaic_tiles_dir = os.path.join(tile_folder, '03_hoogte_fotogram')
create_dir(mosaic_tiles_dir)
# raster_subset_with_tileindex_tiles(tile_extents_path, fotogram_height_path, mosaic_tiles_dir)
...
# # =============================================================================
mosaic_dir = r"G:\08_FrieseZeegat_Fotogrammetrie\6_Vergelijking_met_Lidar\eCognition_Segmentation\Mosaic"
create_dir(mosaic_dir)

input_shapefile_dir = r"G:\08_FrieseZeegat_Fotogrammetrie\6_Vergelijking_met_Lidar\eCognition_Segmentation\New_Segmentation\results"
...
create_work_gdb(mosaic_dir, project_name)
gdb_path = os.path.join(mosaic_dir, f'{project_name}.gdb')
arcpy.env.workspace = gdb_path

input_shapefile_dir_clipped = os.path.join(mosaic_dir, '01_Clipped_Tiles')
shapefile_list = []
