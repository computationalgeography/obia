...
#
input_shapefile_dir = r'C:\Oosterschelde_2016_processing\04_eCognition_Workspace\run_open_plek\02_Output\Classification_Shapefile001'
output_dir = os.path.join(root, '05_Mosaic_run_open_plek')
