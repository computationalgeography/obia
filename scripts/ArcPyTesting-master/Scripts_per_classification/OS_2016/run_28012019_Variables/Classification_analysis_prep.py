...
gdb_name = 'OS_Analysis_preparation_open_plek_variables'
...
# shapefiles to load
classification_path = r'C:\Oosterschelde_2016_processing\05_Mosaic_run_open_plek_variables\Oosterschelde_2016.shp'
