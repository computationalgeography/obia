...
input_shapefile_dir = r'G:\04_Westerschelde\02_Classificatieproces\04_Workspace\ws_rerun_na_os_open_plek\02_Output\Classification_Shapefile_variables'
output_dir = os.path.join(root, '05_Mosaic_run_01022019_final_variables')
