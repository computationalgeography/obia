...
# /mnt/c/edwin/scratch  ls -lah -d *v10/*
# dr-xr-x---    1 Sutan101 UsersGrp       0 Nov 29 13:21 analysis_2016_v10/2016_GMK
# dr-xr-x---    1 Sutan101 UsersGrp       0 Dec  1 13:53 analysis_2016_v10/final
# dr-xr-x---    1 Sutan101 UsersGrp       0 Nov 29 09:53 analysis_2018_v10/default
# dr-xr-x---    1 Sutan101 UsersGrp       0 Nov 29 23:00 analysis_2018_v10/i_2018_calibration_global_brightness_and_plaat_ndvi_done_complete
# dr-xr-x---    1 Sutan101 UsersGrp       0 Dec  1 12:06 analysis_2018_v10/i_2018_calibration_global_brightness_and_plaat_ndvi_final_done
# dr-xr-x---    1 Sutan101 UsersGrp       0 Nov 27 22:51 analysis_2018_v10/ii_2018_calibration_global_brightness_and_plaat_ndvi_nir_nirRatio_green_done
...
#gdb = r'Q:\edwin_2021\04_Westerschelde2016\07_analysis\V9_Pmerge.gdb'
#gdb = r'c:\edwin\scratch\analyze_2018\07_analysis\V9_Pmerge_goodmerge.gdb'

# # 2016
# gdb   = r'c:\edwin\scratch\analysis_2016_v10\final\merged.gdb'

# # 2018 default
# gdb   = r'c:\edwin\scratch\analysis_2018_v10\default\merged.gdb'

# 2018 calibration
gdb     = r'c:\edwin\scratch\analysis_2018_v10\i_2018_calibration_global_brightness_and_plaat_ndvi_final_done\merged.gdb'
...
# # 2018
# figure_dir = r'c:\edwin\scratch\analysis_2018_v10\default'

# 2018 calibration
figure_dir   = r'c:\edwin\scratch\analysis_2018_v10\i_2018_calibration_global_brightness_and_plaat_ndvi_final_done'
...
#                  figure_name='ErrorMatrix_Oppervlakte'+gdb.split('\\')[-1][:-4]+'_P1a__Candidate megaribbel')#merged P1a
                  figure_name='ErrorMatrix_Oppervlakte'+gdb.split('\\')[-1][:-4]+'_P1merged')#P1a1,p1a2
...
#                  figure_name='ErrorMatrix_Oppervlakte'+gdb.split('\\')[-1][:-4]+'_P1a_Candidate megaribbel')
                  figure_name='ErrorMatrix_Oppervlakte'+gdb.split('\\')[-1][:-4]+'_P1merged')
#%%
ecog2klasse = dict(zip(class_eCognition, klasse_subset_list)) #nu niet nodig aangezien al de goede namen
klasse_subset_list = klasse_subset_list = ['Schor',
                      'Schor Open Plek',
...
plot_error_matrix(pivot_perc, col_scale=(0, 100), added_columns=False,
                  save_plot=True, safe_fig_folder=figure_dir,
#                  figure_name='ErrorMatrix_Oppervlakte'+gdb.split('\\')[-1][:-4]+'_P1a__Candidate megaribbel')#merged P1a
                  figure_name='ErrorMatrix_Oppervlakte'+gdb.split('\\')[-1][:-4]+'_P1merged_all')#P1a1,p1a2

# With added columns
plot_error_matrix(error_matrix, col_scale=(1000, 1000), added_columns=True,
                  save_plot=True, safe_fig_folder=figure_dir,
#                  figure_name='ErrorMatrix_Oppervlakte'+gdb.split('\\')[-1][:-4]+'_P1a_Candidate megaribbel')
                  figure_name='ErrorMatrix_Oppervlakte'+gdb.split('\\')[-1][:-4]+'_P1merged_all')