...
import sys
sys.path.append(r'V:\ArcPyTesting-master')
...
gdb_name = 'OS_Analysis_preparation__adj_segmentation_fix'
...
# shapefiles to load
classification_path = r'C:\Oosterschelde_2016_processing\05_Mosaic_run_adj_segmentatie_fix\Oosterschelde_2016.shp'
...
features = [classification_path, gmk_path, macrocells]
